...
This directory contains source files for the K\'iche\' language
...
-   <http://giellatekno.uit.no/qucdoc/index.html>
-   <https://giellalt.uit.no/tools/docu-quc-manual.html>
...
The K\'iche\' language sources can be acquired using [giella SVN
